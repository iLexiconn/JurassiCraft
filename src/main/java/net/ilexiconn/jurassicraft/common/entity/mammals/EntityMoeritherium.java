...
public class EntityMoeritherium extends EntityJurassiCraftProtective implements IHerbivore {
    ...
    protected void dropFewItems(boolean recentlyBeenHit, int enchantBonus) {
        ...
        int count = Math.round(1 + (4.0F * developmentFraction) + this.rand.nextInt(1 + (int) (3.0F * developmentFraction)) + this.rand.nextInt(1 + enchantBonus));
