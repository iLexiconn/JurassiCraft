...
public class ItemLowSecurityFencePoleRenderer implements IItemRenderer {
    public ModelLowSecurityFencePole model = new ModelLowSecurityFencePole();
    public ResourceLocation texture;

    public ItemLowSecurityFencePoleRenderer() {
        texture = new ResourceLocation(JurassiCraft.getModId() + "textures/blocks/fence/low_security_fence_pole.png");
    }
